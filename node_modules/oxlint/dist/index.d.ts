...
type Declaration = VariableDeclaration | Function$1 | Class | TSTypeAliasDeclaration | TSInterfaceDeclaration | TSEnumDeclaration | TSModuleDeclaration | TSImportEqualsDeclaration;
 ...
 *   any of the tokens found between the two given nodes or tokens.
 */
declare function isSpaceBetweenTokens(token1: NodeOrToken, token2: NodeOrToken): boolean;
//#endregion
 ...
 */
type RuleOptionsSchema = Record<string, unknown> | unknown[] | false;
/**
...
//#endregion
export { type AfterHook, type BeforeHook, type Comment, type Context, type CountOptions, type CreateOnceRule, type CreateRule, type Definition, type DefinitionType, type Diagnostic, type types_d_exports as ESTree, type FilterFn, type Fix, type FixFn, type Fixer, type LanguageOptions, type LineColumn, type Location, type Node, type NodeOrToken, type Options, type Plugin, type Range, type RangeOptions, type Ranged, type Reference, type Rule, type RuleDeprecatedInfo, type RuleDocs, type RuleMeta, type RuleOptionsSchema, type RuleReplacedByExternalSpecifier, type RuleReplacedByInfo, type Scope, type ScopeManager, type ScopeType, type Settings, type SkipOptions, type SourceCode, type Span, type Suggestion, type Token, type Variable, type VisitorObject as Visitor, type VisitorWithHooks, definePlugin, defineRule };