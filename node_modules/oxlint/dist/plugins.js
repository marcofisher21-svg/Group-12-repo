...
var __create = Object.create, __defProp = Object.defineProperty, __getOwnPropDesc = Object.getOwnPropertyDescriptor, __getOwnPropNames = Object.getOwnPropertyNames, __getProtoOf = Object.getPrototypeOf, __hasOwnProp = Object.prototype.hasOwnProperty, __commonJSMin = (cb, mod) => () => (mod || cb((mod = { exports: {} }).exports, mod), mod.exports), __copyProps = (to, from, except, desc) => {
	...
	value: mod,
	enumerable: !0
}) : target, mod)), keys_default = Object.freeze({
	DebuggerStatement: [],
	EmptyStatement: [],
	Literal: [],
	PrivateIdentifier: [],
...
function getTokenOrCommentBefore(nodeOrToken, skip) {
	throw Error("`sourceCode.getTokenOrCommentBefore` not implemented yet");
}
...
function getTokenOrCommentAfter(nodeOrToken, skip) {
	throw Error("`sourceCode.getTokenOrCommentAfter` not implemented yet");
}
...
function isSpaceBetweenTokens(token1, token2) {
...
const { isArray: isArray$2 } = Array, { freeze: freeze$1 } = Object;
function deepFreezeJsonValue(value) {
	if (!(typeof value != "object" || !value)) {
		if (isArray$2(value)) for (let i = 0, len = value.length; i !== len; i++) deepFreezeJsonValue(value[i]);
		else for (let key in value) deepFreezeJsonValue(value[key]);
		freeze$1(value);
	}
}
...
const PARSER_OPTIONS = freeze({ get sourceType() {
	return ast === null && initAst(), ast.sourceType;
} }), LANGUAGE_OPTIONS = freeze({
	get sourceType() {
		return ast === null && initAst(), ast.sourceType;
	},
	ecmaVersion: 2026,
	get parser() {
		throw Error("`context.languageOptions.parser` not implemented yet.");
	},
